-- ============================================
-- CLARA: Master Document Register View (updated)
-- ============================================
...
SELECT
  ...
  d.valid_until as masa_berlaku,
  CASE
    WHEN d.valid_until IS NULL THEN NULL
    WHEN d.valid_until < CURRENT_DATE THEN 'Berakhir'
    WHEN d.valid_until <= CURRENT_DATE + INTERVAL '30 days' THEN 'Akan Berakhir'
    ELSE 'Aktif'
  END as status_masa_berlaku,
...
ALTER VIEW master_document_register SET (security_invoker = true);
